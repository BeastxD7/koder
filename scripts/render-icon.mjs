// Renders assets/icon.svg → assets/koder.icns (needs `npm i sharp` somewhere on PATH).
...
execSync(`iconutil -c icns ${iconset} -o assets/koder.icns`);
console.log("assets/koder.icns regenerated");

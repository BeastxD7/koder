...
kicker(s, "Product pitch — YC · Microsoft for Startups · AWS Activate", top=Inches(1.0))
...
headline(s, "Fuel for the single-player product's growth, and the infrastructure the multiplayer bet needs.",
         size=24, height=Inches(1.5))
asks = [
    ("YC", "Speed and rigor on GTM — turning five design-partner teams into a repeatable enterprise motion."),
    ("Microsoft for Startups", "Azure credits to host the shared Agent Brain service, plus distribution through VS Code's own ecosystem."),
    ("AWS Activate", "Compute credits for the trace/index infrastructure a team-scale Brain runs on, at pilot-cohort scale."),
]
for i, (who, desc) in enumerate(asks):
    card(s, Inches(0.8 + i * 3.85), Inches(2.9), Inches(3.7), Inches(2.5), who, desc, label_size=13, desc_size=11.5)
add_text(s, Inches(0.8), Inches(5.7), Inches(11), Inches(0.8),
